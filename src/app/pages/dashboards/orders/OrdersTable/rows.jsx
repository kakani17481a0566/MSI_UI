  ...
  return (
    <div className="flex items-center space-x-4 ">
      ...
      <span className="font-medium text-gray-800 dark:text-dark-100">
        ...
        <p className="mt-0.5 text-xs text-gray-400 dark:text-dark-300">9474947484</p>
      </span>
    </div>
  );
}
...
export function TotalCell() {
  ...
  return (
    <p className="text-sm-plus font-medium text-gray-800 dark:text-dark-100">
       <p className="font-medium">My School Italy</p>
       <p className="mt-0.5 text-xs text-gray-400 dark:text-dark-300">Branch 1</p>
    </p>
  );
}

export function ProfitCell({ getValue}) {
  return (
