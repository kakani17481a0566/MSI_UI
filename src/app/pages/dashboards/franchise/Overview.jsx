...
const data = {
  yearly: {
    ...
    categories: ["Aug-24", "Sep-24", "Oct-24", "Nov-24", "Dec-24", "Jan-25", "Feb-25", "Mar-25", "Apr-25"],
  },
  monthly: {
    series: [
      {
    ...
    <Card className="col-span-12 lg:col-span-8">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 px-4 sm:mt-5 sm:grid-cols-4 sm:px-5 lg:mt-6">
        <div className="rounded-lg bg-gray-100 p-3 dark:bg-surface-3 2xl:p-4">
          ...
          <p className="mt-1 text-xs-plus">No of Schools</p>
        </div>
        <div className="rounded-lg bg-gray-100 p-3 dark:bg-surface-3 2xl:p-4">
          <div className="flex justify-between space-x-1">
            <p className="text-xl font-semibold text-gray-800 dark:text-dark-100">
          ...
          <p className="mt-1 text-xs-plus">No of Students</p>
        </div>
        <div className="rounded-lg bg-gray-100 p-3 dark:bg-surface-3 2xl:p-4">
          <div className="flex justify-between space-x-1">
            <p className="text-xl font-semibold text-gray-800 dark:text-dark-100">
          ...
          <p className="mt-1 text-xs-plus">Revenu</p>
        </div>
        <div className="rounded-lg bg-gray-100 p-3 dark:bg-surface-3 2xl:p-4">
          <div className="flex justify-between space-x-1">
            <p className="text-xl font-semibold text-gray-800 dark:text-dark-100">
          ...
          <p className="mt-1 text-xs-plus">Recived Revenu</p>
        </div>
      </div>
